...
interface Report {
  id: string;
  name: string;
  type: 'vehicle' | 'booking' | 'financial' | 'user' | 'maintenance';
  description: string;
...
const mockReports: Report[] = [
  ...
  },
  {
    ...
    type: 'financial',
    description: 'Revenue, costs, and profitability analysis for the quarter',
...
const reportTemplates = [
  ...
  },
  {
    ...
    icon: DollarSign,
    metrics: ['Total Revenue', 'Operating Costs', 'Profit Margin', 'ROI Analysis']
  },
  {
    id: 'user-engagement',
